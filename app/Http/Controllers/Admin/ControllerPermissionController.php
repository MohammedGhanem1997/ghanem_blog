...
//                    dd($user->id);
    ...
    {
        return view('admin.pages.permission.controller.index');
    ...
    {
        $controller= \App\Models\Controller::where('name',$id)->first();
        return view('admin.pages.permission.controller.edit',compact('controller'));
