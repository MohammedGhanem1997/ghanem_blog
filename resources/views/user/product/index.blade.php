...
@section('contain')
    ...
    @push('seo')
        @include('layout.include.seo.all-products')
    @endpush


    <div class="page-head">
        <div class="page-head__bg" style="background-image: url({{asset('images/defult/productspage.jpg')}})">
            <div class="page-head__content" data-uk-parallax="y: 0, 100">
                <div class="uk-container uk-container-xlarge">
                    <div class="uk-margin-remove-top page-head__title"> {{translateview('all products')}}</div>
                    ...
                    @foreach($products as $product)
                        <div class="rental-item">
                            <div class="rental-item__media"> <img src="{{ count($product->product_images) == 0?  asset('images/main/rental-item-5.jpg' ): asset($product->product_images[0]->image)}}" alt="Special Attachment Excavator">
                                <div class="rental-item__links"> <a href="{{route('sub-category-products',$product->sub_category->slug)}}">{{translate('view main category')}}</a><a href="#">{{translate('Print product')}}</a></div>
                            </div>
