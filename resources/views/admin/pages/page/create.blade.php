    ...
    <div class="app-content my-3 my-md-5">
        <div class="side-app">
            <div class="page-header" dir="rtl">
                <h4 class="page-title">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{translate('add page')}}</li>
                    </ol>
                </h4>
            ...
            <div class="card m-b-20">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.page.store')}}" method="post" enctype="multipart/form-data" >
                        ...
                        <div id="tab_description_ar" class=" tab-content tab-contain currentinput">
                            <textarea id="myEditor" class="" name="content_ar"></textarea>


                        </div>
                        <div id="tab_description_en" class="tab-content  tab-contain">
                            <textarea id="myEditor2" class="" name="content_en"></textarea>
                ...
                <div class="row">
                    <div class="col-lg-12 col-sm-12 pr-7 pl-7">
                        <label class="form-label">  {{translate('image')}}  </label>

                        <input type="file" name="image"  data-default-file="" class="dropify" data-height="180" />
                    </div>
                    ...
                    <div class="form-group col-md-6 text-md-center">
                        ...
                        <label class="custom-switch">
                            ...
                            <input type="checkbox" name="status" value="1"    checked   class="custom-switch-input form-control ">
