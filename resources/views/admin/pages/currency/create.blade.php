        ...
        <div class="side-app">
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"> {{translate('Create')}} {{translate('currency')}}</li>
                </ol>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.currency.store')}}" method="post" enctype="multipart/form-data" >
                            ...
                            <div class="form-group col-md-6">
                                <div class="form-group">
                                    ...
                                    <div id="tab_title_ar" class="tab-title tab-content currentinput">
                                        <input type="text" name="title_ar" class="form-control" id="name2" placeholder=" {{ translation(lable('currency')) }} " required>


                                    </div>
                                    <div id="tab_title_en" class="tab-title tab-content">
                                        <input type="text" name="title_en" class="form-control" id="name" placeholder=" {{ translation(lable('currency')) }} " required>
                        ...
                        <br>
                            <br>
                        <button type="submit" class="btn btn-primary btn-block">{{translate('Create')}}</button>
                        </div>
                    </form>
